...
import { PluginHost } from "@auditcode/core/plugin/host"
import { ProviderPlugins } from "@auditcode/core/plugin/provider"
import { ZenmuxPlugin } from "@auditcode/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://github.com/itsdarktoday/auditcode", "X-Title": "auditcode" })
