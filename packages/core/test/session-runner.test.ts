...
import * as OpenAIChat from "@auditcode/llm/protocols/openai-chat"
import { Database } from "@auditcode/core/database/database"
import { makeLocationNode } from "@auditcode/core/effect/app-node"
...
import { PermissionV2 } from "@auditcode/core/permission"
import { EventTable } from "@auditcode/core/event/sql"
import { Project } from "@auditcode/core/project"
import { ProjectTable } from "@auditcode/core/project/sql"
import { QuestionV2 } from "@auditcode/core/question"
import { AbsolutePath } from "@auditcode/core/schema"
import { SessionV2 } from "@auditcode/core/session"
import { Snapshot } from "@auditcode/core/snapshot"
import { ContextSnapshotDecodeError } from "@auditcode/core/session/error"
import { SessionEvent } from "@auditcode/core/session/event"
import { SessionInput } from "@auditcode/core/session/input"
import { SessionMessage } from "@auditcode/core/session/message"
import { Prompt } from "@auditcode/core/session/prompt"
import { SessionProjector } from "@auditcode/core/session/projector"
import { SessionExecution } from "@auditcode/core/session/execution"
import { SessionRunCoordinator } from "@auditcode/core/session/run-coordinator"
import { SessionRunner } from "@auditcode/core/session/runner"
import * as SessionRunnerLLM from "@auditcode/core/session/runner/llm"
import { SessionRunnerModel } from "@auditcode/core/session/runner/model"
import { ToolRegistry } from "@auditcode/core/tool/registry"
import { ApplicationTools } from "@auditcode/core/tool/application-tools"
import { AgentV2 } from "@auditcode/core/agent"
import { Config } from "@auditcode/core/config"
import { ConfigCompaction } from "@auditcode/core/config/compaction"
import { Tool } from "@auditcode/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@auditcode/core/session/sql"
import { SessionStore } from "@auditcode/core/session/store"
import { SystemContext } from "@auditcode/core/system-context"
import { SystemContextRegistry } from "@auditcode/core/system-context/registry"
import { SkillGuidance } from "@auditcode/core/skill/guidance"
import { ReferenceGuidance } from "@auditcode/core/reference/guidance"
...
describe("SessionRunnerLLM", () => {
  ...
  it.effect("includes the effective default agent system before durable context", () =>
    Effect.gen(function* () {
      ...
      yield* agent.transform((editor) =>
        editor.update(AgentV2.ID.make("audit"), (agent) => {
  ...
  it.effect("updates selected-agent skill guidance after an agent switch", () =>
    Effect.gen(function* () {
      ...
      const session = yield* SessionV2.Service
      const events = yield* EventV2.Service
      skillBaselines.set(AgentV2.ID.make("audit"), "Build skills")
      yield* session.prompt({ sessionID, prompt: Prompt.make({ text: "First" }), resume: false })
