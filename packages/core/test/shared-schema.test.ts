...
import { SessionV2 } from "@auditcode/core/session"
import { Agent } from "@auditcode/schema/agent"
import { Location } from "@auditcode/schema/location"
import { Model } from "@auditcode/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@auditcode/schema/prompt"
import { Provider } from "@auditcode/schema/provider"
import { Project } from "@auditcode/schema/project"
import { ProjectDirectories } from "@auditcode/schema/project-directories"
import { PermissionV1 } from "@auditcode/schema/permission-v1"
import { Session } from "@auditcode/schema/session"
import { SessionInput } from "@auditcode/schema/session-input"
import { SessionMessage } from "@auditcode/schema/session-message"
import { Workspace } from "@auditcode/schema/workspace"
import { Command } from "@auditcode/schema/command"
import { Connection } from "@auditcode/schema/connection"
import { Credential } from "@auditcode/schema/credential"
import { FileSystem } from "@auditcode/schema/filesystem"
import { Integration } from "@auditcode/schema/integration"
import { LLM } from "@auditcode/schema/llm"
import { Permission } from "@auditcode/schema/permission"
import { Plugin } from "@auditcode/schema/plugin"
import { Pty } from "@auditcode/schema/pty"
import { Reference } from "@auditcode/schema/reference"
import { SessionTodo } from "@auditcode/schema/session-todo"
import { Skill } from "@auditcode/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@auditcode/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@auditcode/core/command"),
    import("@auditcode/core/integration/connection"),
    import("@auditcode/core/credential"),
    import("@auditcode/core/filesystem"),
    import("@auditcode/core/integration"),
    import("@auditcode/core/location"),
    import("@auditcode/llm"),
    import("@auditcode/core/permission"),
    import("@auditcode/core/v1/permission"),
    import("@auditcode/core/project/copy"),
    import("@auditcode/core/pty"),
    import("@auditcode/core/project/schema"),
    import("@auditcode/core/reference"),
    import("@auditcode/core/session/input"),
    import("@auditcode/core/session/message"),
    import("@auditcode/core/session/todo"),
    import("@auditcode/core/session/prompt"),
    import("@auditcode/core/skill"),
    import("@auditcode/core/v2-schema"),
    import("@auditcode/core/schema"),
    import("@auditcode/core/workspace"),
  ])
