...
import { Event } from "@auditcode/schema/project-directories"
import { ProjectCopy } from "@auditcode/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/ProjectCopy") {}
