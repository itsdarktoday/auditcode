...
import type { EffectDrizzleSqlite } from "@auditcode/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/ProjectDirectories") {}
