...
import { Entry, FileSystem, FindInput, Match } from "@auditcode/schema/filesystem"
export { Entry, Match, Submatch } from "@auditcode/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/v2/FileSystem") {}
