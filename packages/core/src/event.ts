...
import type { Data, Definition, Payload } from "@auditcode/schema/event"
...
import { Durable } from "@auditcode/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@auditcode/schema/event").ID
export type { Data, Definition, Payload } from "@auditcode/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/Event") {}
