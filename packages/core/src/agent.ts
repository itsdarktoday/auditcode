...
export const defaultID = ID.make("audit")
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/v2/Agent") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const selectedDefault = () => {
      ...
      const audit = selectable(data.agents.get(ID.make("audit")))
    ...
    return Service.of({
      ...
      get: Effect.fn("AgentV2.get")(function* (id) {
        if (id === ID.make("build")) return state.get().agents.get(ID.make("audit"));
