...
import { ListAnchor } from "@auditcode/schema/session"
...
import { SessionDurable } from "@auditcode/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/v2/Session") {}
