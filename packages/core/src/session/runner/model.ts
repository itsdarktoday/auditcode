...
import { type Model } from "@auditcode/llm"
import * as AnthropicMessages from "@auditcode/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@auditcode/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@auditcode/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@auditcode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/v2/SessionRunnerModel") {}
