...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@auditcode/llm"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/v2/ToolRegistry") {}
