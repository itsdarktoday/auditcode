...
import type { IntegrationOAuthMethodRegistration } from "@auditcode/plugin/v2/effect/integration"
import { define } from "@auditcode/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `auditcode/${InstallationVersion}` }
}
