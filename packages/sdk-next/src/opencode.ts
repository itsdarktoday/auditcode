import { OpenCode } from "@auditcode/client/effect"
...
import { createEmbeddedRoutes } from "@auditcode/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/sdk-next/OpenCode") {}
