...
import { makeGlobalNode } from "@auditcode/core/effect/app-node"
...
import { InstallationChannel } from "@auditcode/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("itsdarktoday/tap/opencode")) return ""
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("itsdarktoday/tap/opencode") && args.includes("--formula")) return "opencode"
