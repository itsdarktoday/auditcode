...
import type * as SDK from "@auditcode/sdk/v2"
...
import { SessionShareTable } from "@auditcode/core/share/sql"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/ShareNext") {}
