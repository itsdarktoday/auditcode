...
import { normalizePromptContent } from "@auditcode/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@auditcode/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close AuditCode" } satisfies SlashOption,
    ]
