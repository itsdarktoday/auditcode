...
//
// The saved variant persists across sessions in ~/.local/state/auditcode/model.json
...
class Service extends Context.Service<Service, VariantService>()("@auditcode/RunVariant") {}
