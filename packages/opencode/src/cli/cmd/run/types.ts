// Shared type vocabulary for the direct interactive mode (`auditcode --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@auditcode/sdk/v2"
import type { TuiConfig } from "@auditcode/tui/config"
