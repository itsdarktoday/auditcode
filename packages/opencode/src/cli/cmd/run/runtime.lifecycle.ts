...
import { openEditor } from "@auditcode/tui/editor"
import { registerOpencodeKeymap } from "@auditcode/tui/keymap"
...
function footerLabels(input: Pick<RunInput, "agent" | "model" | "variant">): FooterLabels {
  const agentLabel = Locale.titlecase(input.agent ?? "pentest")
