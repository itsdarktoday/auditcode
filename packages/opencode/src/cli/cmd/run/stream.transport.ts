...
import type { Event, GlobalEvent, OpencodeClient } from "@auditcode/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@auditcode/RunStreamTransport") {}
