...
import { llmClient } from "@auditcode/core/effect/app-node-platform"
...
import type { LLMEvent } from "@auditcode/llm"
import { LLMClient } from "@auditcode/llm/route"
import type { LLMClientService } from "@auditcode/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via auditcode's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @auditcode/llm. It
