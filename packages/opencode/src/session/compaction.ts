...
import { buildPrompt } from "@auditcode/core/session/compaction"
import { SessionCompactionEvent } from "@auditcode/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/SessionCompaction") {}
