...
import { Slug } from "@auditcode/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@auditcode/llm"
...
import { locationServiceMapLayer } from "@auditcode/core/location-services"
...
import { PartTable, SessionTable } from "@auditcode/core/session/sql"
...
import { WorkspaceV2 } from "@auditcode/core/workspace"
import { SessionID, MessageID, PartID } from "./schema"

import type { Provider } from "@/provider/provider"
import { Global } from "@auditcode/core/global"
import { Effect, Layer, Option, Context, Schema, Types } from "effect"
import { NonNegativeInt, optional } from "@auditcode/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".auditcode", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/Session") {}
