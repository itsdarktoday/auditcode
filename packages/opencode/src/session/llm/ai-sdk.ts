import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@auditcode/llm"
...
// Move this extraction into @auditcode/llm when Copilot is handled by the native runtime.
