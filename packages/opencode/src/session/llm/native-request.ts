import type { JsonSchema, LLMRequest, ProviderMetadata } from "@auditcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@auditcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @auditcode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
