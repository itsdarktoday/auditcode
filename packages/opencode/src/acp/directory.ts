...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@auditcode/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@auditcode/ACPDirectory") {}
