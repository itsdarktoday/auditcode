...
import { AccountStateTable, AccountTable } from "@auditcode/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/AccountRepo") {}
