import type { Hooks, PluginInput } from "@auditcode/plugin"
import type { Model } from "@auditcode/sdk/v2"
import { InstallationVersion } from "@auditcode/core/installation/version"
import { OauthCallbackPage } from "@auditcode/core/oauth/page"
...
async function listRouters(
  ...
  const res = await fetch(`${DO_GENAI_API}/models/routers`, {
    headers: {
      ...
      "User-Agent": `auditcode/${InstallationVersion}`,
    },
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. AuditCode will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
