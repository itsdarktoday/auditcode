...
import { makeApi } from "@auditcode/protocol/api"
import { LocationMiddleware } from "@auditcode/server/location"
import { SessionLocationMiddleware } from "@auditcode/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("auditcode-root")
...
export const InstanceHttpApi = HttpApi.make("auditcode-instance")
...
export const OpenCodeHttpApi = HttpApi.make("auditcode")
