...
import { EventSequenceTable, EventTable } from "@auditcode/core/event/sql"
...
import { WorkspaceEvent } from "@auditcode/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@auditcode/Workspace") {}
