...
export const TypeId: TypeId = "~@auditcode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@auditcode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@auditcode/effect-sqlite-node/NodeSqliteClient")
