...
function App(props: { onSnapshot?: () => Promise<string[]>; pluginHost: TuiPluginHost }) {
  ...
  createEffect(() => {
    ...
    if (route.data.type === "home") {
      renderer.setTerminalTitle("AuditCode")
      return
    }
  ...
  const appCommands = createMemo(() =>
    [
      ...
      {
        name: "small_model.set",
        title: "Set cheap model (offload)",
        category: "Agent",
        slashName: "small-model",
      ...
      },
      {
        ...
        title: "Open docs",
        run: () => {
          open("https://github.com/itsdarktoday/auditcode").catch(() => {})
          dialog.clear()
        },
        category: "System",
      },
  ...
  event.on("installation.update-available", async (evt) => {
    ...
    await DialogAlert.show(
      dialog,
      "Update Complete",
      `Successfully updated to AuditCode v${result.data.version}. Please restart the application.`,
    )
