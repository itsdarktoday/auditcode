...
import defaultSoundPath from "@auditcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@auditcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@auditcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@auditcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@auditcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@auditcode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "auditcode"
const DEFAULT_PACK_ID = "auditcode.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "AuditCode Default",
  builtin: true,
  sounds: {
