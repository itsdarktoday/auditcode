...
beforeAll(async () => {
  ...
  mock.module("@auditcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@auditcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@auditcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@auditcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
